...
def init_model():
    ...
    parser.add_argument("--lr2", type=float, default=0.0001, help="The learning rate of the decision boundary.")
    parser.add_argument("--num_subcentroids", default=4, type=int,
                        help="number of subcentroids.")
    ...
    parser.add_argument("--purity_get_ball", default=1, type=int,
                        help="the purity of granular ball in get ball.")
    parser.add_argument("--purity_select_ball", default=0.9, type=int,
    ...
    parser.add_argument("--min_ball_get_ball", default=5, type=int,
                        help="min_ball of granular ball in get ball..")
    parser.add_argument("--min_ball_select_ball", default=10, type=int,
